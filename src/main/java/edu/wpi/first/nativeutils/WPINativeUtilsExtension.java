...
public class WPINativeUtilsExtension {
    ...
    public List<String> macCompilerArgs = Collections.unmodifiableList(Arrays.asList("-std=c++14", "-Wall", "-Wextra",
            "-Werror", "-pedantic-errors", "-fPIC", "-g", "-Wno-unused-parameter", "-Wno-error=deprecated-declarations",
    ...
    public List<String> macLinkerArgs = Collections
            .unmodifiableList(Arrays.asList("-framework", "CoreFoundation", "-framework", "AVFoundation", "-framework",
                    "Foundation", "-framework", "CoreMedia", "-framework", "CoreVideo"));
    ...
    public WPINativeUtilsExtension(NativeUtilsExtension nativeExt) {
        ...
        PlatformConfig windowsx86_64 = nativeExt.getPlatformConfigs().create(windowsx64);
        PlatformConfig windowsx86 = nativeExt.getPlatformConfigs().create(this.windowsx86);
        PlatformConfig linuxx86_64 = nativeExt.getPlatformConfigs().create(linuxx64);
        PlatformConfig osxx86_64 = nativeExt.getPlatformConfigs().create(osxx64);
        PlatformConfig linuxathena = nativeExt.getPlatformConfigs().create(roborio);
        PlatformConfig linuxraspbian = nativeExt.getPlatformConfigs().create(raspbian);
