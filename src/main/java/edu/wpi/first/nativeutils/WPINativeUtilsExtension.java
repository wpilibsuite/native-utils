...
public class WPINativeUtilsExtension {
  ...
  public static class DefaultArguments {
    ...
    public final List<String> windowsCompilerArgs =
        List.of(
            "/EHsc",
            "/FS",
            "/Zc:inline",
            ...
            "/Zc:__cplusplus",
            "/Zc:preprocessor",
            "/wd5105"); // 5105 is thrown by windows sdk headers
    public final List<String> windowsCCompilerArgs =
        List.of("/FS", "/Zc:inline", "/D_CRT_SECURE_NO_WARNINGS");
    ...
    public final List<String> linuxCrossCompilerArgs =
        List.of(
            "-std=c++20",
            "-Wformat=2",
            "-pedantic",
            ...
            "-fPIC",
            "-pthread");
    public final List<String> linuxCrossCompilerExtraArgs11 =
        List.of("-Wno-error=deprecated-enum-enum-conversion");
    public final List<String> linuxCrossCCompilerArgs =
        List.of(
            "-Wformat=2", "-pedantic", "-Wno-psabi", "-Wno-unused-parameter", "-fPIC", "-pthread");
    public final List<String> linuxCrossLinkerArgs =
        List.of("-rdynamic", "-pthread", "-ldl", "-latomic");
    ...
    public final List<String> linuxCompilerArgs =
        List.of(
            "-std=c++20",
            "-Wformat=2",
            "-pedantic",
            ...
            "-fPIC",
            "-pthread");
    public final List<String> linuxCCompilerArgs =
        List.of(
            "-Wformat=2", "-pedantic", "-Wno-psabi", "-Wno-unused-parameter", "-fPIC", "-pthread");
    public final List<String> linuxLinkerArgs =
        List.of("-rdynamic", "-pthread", "-ldl", "-latomic");
    ...
    public final List<String> macCompilerArgs =
        List.of(
            "-std=c++20",
            "-pedantic",
            "-fPIC",
            ...
            "-pthread");
    public final List<String> macCCompilerArgs =
        List.of(
            "-pedantic",
            "-fPIC",
            "-Wno-unused-parameter",
    ...
    public final List<String> macObjcppCompilerArgs =
        List.of("-std=c++20", "-stdlib=libc++", "-fobjc-weak", "-fobjc-arc", "-fPIC");
    ...
    public final List<String> macLinkerArgs =
        List.of(
            "-framework",
            "CoreFoundation",
            "-framework",
  ...
  public static class Platforms {
    ...
    public final List<String> allPlatforms =
        List.of(roborio, linuxarm32, linuxarm64, windowsx64, windowsx86, osxuniversal, linuxx64);
    public final List<String> desktopPlatforms =
        List.of(windowsx64, windowsx86, osxuniversal, linuxx64);
  }
  ...
  public void addLinuxCrossArgs(PlatformConfig platform, int gccMajor) {
    ...
    platform
        .getCppCompiler()
        .getReleaseArgs()
        .addAll(defaultArguments.linuxCrossReleaseCompilerArgs);
  ...
  public abstract static class DependencyVersions {
  ...
  private void registerStandardDependency(
    ...
    configs.register(
        name + "_shared",
        WPISharedMavenDependency.class,
        c -> {
    ...
    configs.register(
        name + "_static",
        WPIStaticMavenDependency.class,
        c -> {
          c.getGroupId().set(groupId);
          c.getArtifactId().set(artifactId);
          c.getHeaderClassifier().set("headers");
  ...
  public void configureDependencies(Action<DependencyVersions> dependencies) {
    ...
    ExtensiblePolymorphicDomainObjectContainer<NativeDependency> configs =
        nativeExt.getNativeDependencyContainer();
    configs.register(
        "netcomm",
        WPISharedMavenDependency.class,
        c -> {
    ...
    registerStandardDependency(
        configs, "wpiutil", "edu.wpi.first.wpiutil", "wpiutil-cpp", wpiVersion);
    ...
    registerStandardDependency(
        configs, "cameraserver", "edu.wpi.first.cameraserver", "cameraserver-cpp", wpiVersion);
    registerStandardDependency(
        configs, "wpilibc", "edu.wpi.first.wpilibc", "wpilibc-cpp", wpiVersion);

    registerStandardDependency(
        configs, "wpimath", "edu.wpi.first.wpimath", "wpimath-cpp", wpiVersion);
    registerSharedOnlyStandardDependency(
        configs, "apriltag", "edu.wpi.first.apriltag", "apriltag-cpp", wpiVersion);

    Provider<String> opencvYearGroup =
        provider.provider(
            () ->
                "edu.wpi.first.thirdparty." + dependencyVersions.getOpencvYear().get() + ".opencv");
    Provider<String> googleTestYearGroup =
        provider.provider(
            () -> "edu.wpi.first.thirdparty." + dependencyVersions.getGoogleTestYear().get());

    registerStandardDependency(
        configs, "opencv", opencvYearGroup, "opencv-cpp", dependencyVersions.getOpencvVersion());
    registerStaticOnlyStandardDependency(
        configs,
        "googletest",
        googleTestYearGroup,
        "googletest",
    ...
    configs.register(
        ...
        c -> {
          ListProperty<String> d = c.getDependencies();
          d.set(
              List.of("cameraserver_shared", "cscore_shared", "apriltag_shared", "opencv_shared"));
        });
