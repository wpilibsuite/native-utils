...
public class DelegatedDependencySet
    implements NativeDependencySet, Named, SourceContainingNativeDependencySet {
  ...
  @Inject
  public DelegatedDependencySet(
      String name,
      NamedDomainObjectCollection<NativeDependency> dependencyCollection,
      boolean required,
    ...
    this.dependencyCollection =
        Objects.requireNonNull(dependencyCollection, "Must have a valid depenedency collection");
    this.binary = binary;
  ...
  private void resolve() {
    ...
    ResolvedNativeDependency resolvedDep =
        resolvedDependency.resolveNativeDependency(binary, fastDownloadSet);
