  ...
  public void apply(Project project) {
    ...
    try {
      project
          .getRootProject()
          .getTasks()
          .named(SOURCE_LINK_ROOT_TASK_NAME, SourceLinkGenerationTask.class);
      ...
      if (gitDir == null) {
        System.out.println(
            "No .git directory was found in"
                + project.getRootProject().getRootDir().toString()
        ...
        project
            .getRootProject()
            .getTasks()
            .register(SOURCE_LINK_ROOT_TASK_NAME, SourceLinkGenerationTask.class, gitDir);
