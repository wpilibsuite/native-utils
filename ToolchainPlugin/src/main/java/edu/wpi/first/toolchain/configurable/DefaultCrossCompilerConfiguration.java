...
public class DefaultCrossCompilerConfiguration implements CrossCompilerConfiguration {
  ...
  public DefaultCrossCompilerConfiguration(String name, ObjectFactory factory) {
    this.name = name;
    this.optional = factory.property(Boolean.class);
  }

  public DefaultCrossCompilerConfiguration(String name, Property<Boolean> optional, ToolchainDescriptorBase descriptor) {
    this.name = name;
