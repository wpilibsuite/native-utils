  ...
  public void apply(Project project) {
    ...
    opensdk =
        new OpenSdkToolchainBase(
            ...
            arm32Ext,
            project,
            Arm32ToolchainExtension.INSTALL_SUBDIR,
            "raspi-bullseye",
            project.provider(() -> "armv6-bullseye-linux-gnueabihf"),
            toolchainExt.getToolchainGraphService());

    CrossCompilerConfiguration configuration =
        project
            .getObjects()
            .newInstance(CrossCompilerConfiguration.class, NativePlatforms.linuxarm32);
