  ...
  public void apply(Project project) {
    ...
    opensdk =
        new OpenSdkToolchainBase(
            ...
            arm64Ext,
            project,
            Arm64ToolchainExtension.INSTALL_SUBDIR,
            "bullseye",
            project.provider(() -> "aarch64-bullseye-linux-gnu"),
            toolchainExt.getToolchainGraphService());

    CrossCompilerConfiguration configuration =
        project
            .getObjects()
            .newInstance(CrossCompilerConfiguration.class, NativePlatforms.linuxarm64);
